  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the power of AI with PromptGen, your reliable partner for generating innovative prompts for top AI tools like chatgpt."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Experience the power of AI with PromptGen, your reliable partner for generating innovative prompts for top AI tools like chatgpt.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1655721528985-c491cc1a3d57?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBSSUyQ2NoYXRib3R8ZW58MHx8fHwxNjg5NDM4NzE2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
